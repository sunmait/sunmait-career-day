...
export class CareerDayService implements ICareerDayService {
  ...
  public async getCareerDaysByEmployeeId(EmployeeId: string): Promise<CareerDayEntity[]> {
  ...
  public async getActiveCareerDay(EmployeeId: string): Promise<CareerDayEntity> {
  ...
  public async addCareerDay(data: Partial<CareerDayEntity>): Promise<CareerDayEntity> {
    // @ts-ignore-next-line
    return this._careerDayRepository.create(data);
  }
  ...
  public async archiveCareerDay(id: number, user: IUserEntity): Promise<CareerDayEntity> {
