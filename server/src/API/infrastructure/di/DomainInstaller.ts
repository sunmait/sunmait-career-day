...
import { ICareerDayService, IObjectiveService, IMailerService } from '../../../Domain/Services';
import {
  CareerDayService,
  ObjectiveService,
  MailerService,
...
export class DomainInstaller extends InstallerBase {
  public install(): void {
    this.container.bind<ICareerDayService>('CareerDayService').to(CareerDayService);
    this.container.bind<IObjectiveService>('ObjectiveService').to(ObjectiveService);
