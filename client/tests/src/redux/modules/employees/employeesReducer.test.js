...
describe('employeesReducer', () => {
  ...
  describe('state with empty parameters', () => {
    test('Should return default state', () => {
      console.log('hellooooo dima');
      console.log('hellooooo VSCode');
  ...
  describe('method handleGetEmployeesList', () => {
    test('Should return list of employees', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.GET_EMPLOYEES_LIST,
        payload: employees,
      };
  ...
  describe('method handleGetCareerDaysOfEmployee', () => {
    test('Should return list of career day', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.GET_CAREER_DAYS,
        payload: careerDayOfEmployee,
      };
      const changedState = employeesReducer(undefined, initAction);
  ...
  describe('method handleGetSelectedCareerDay', () => {
    test('Should return list of selected career day', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.GET_SELECTED_CAREER_DAY,
        payload: careerDayOfEmployee,
      };
      const changedState = employeesReducer(undefined, initAction);
  ...
  describe('method handleGetSelectedEmployee', () => {
    test('Should return list of selected employees', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.GET_SELECTED_EMPLOYEE,
        payload: employees,
      };
      const changedState = employeesReducer(undefined, initAction);
  ...
  describe('method handleAddCareerDay', () => {
    test('Should return updated list of career day after adding career day', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.ADD_CAREER_DAY,
        payload: careerDayOfEmployee,
      };
  ...
  describe('method handleAddObjective', () => {
    test('Should return updated list of career days after adding objective', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.ADD_OBJECTIVE,
        payload: careerDayOfEmployee,
      };
  ...
  describe('method handleDeleteCareerDay', () => {
    test('Should return updated list of career days after deleting career day ', () => {
      const careerDayId = 1;
      const initAction = {
        type: EMPLOYEES_ACTION.DELETE_CAREER_DAY,
        payload: careerDayId,
      };
  ...
  describe('method handleUpdateInterviewDatetime', () => {
    test('Should return updated current career day', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.UPDATE_INTERVIEW_DATETIME,
        payload: careerDayOfEmployee,
      };
  ...
  describe('method handleUpdateObjective', () => {
    test('Should return updated list of career days after editing objective when it equal the current objective ', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.UPDATE_OBJECTIVE_MANAGER,
        payload: objective,
      };
    ...
    test('Should return updated list of career days after editing objective when it not equal the current objective', () => {
      const objective = {
        id: 2,
        Title: 'Title',
        Description: 'Description',
  ...
  describe('method  handleDeleteObjective', () => {
    test('Should return updated list of selected career days after deleting objective', () => {
      const initAction = {
        type: EMPLOYEES_ACTION.DELETE_OBJECTIVE,
        payload: careerDayOfEmployee,
      };
